...
public class Enseignement_notes extends JPanel {
    ...
    public Enseignement_notes() {
        ...
        for(int i = 0 ; i < cours.size() ; i++ ){
           ...
           lib.addMouseListener(new java.awt.event.MouseAdapter(){
               ...
               public void mouseEntered(MouseEvent e) {
                   lib.setBackground(grey);
               }

               @Override
               public void mouseExited(MouseEvent e) {
                   lib.setBackground(col);
               }
        ...
        conPan.setPreferredSize(new Dimension(784 , students.size()* 30 + 70));
        conPan.setOpaque(false);
        conPan.setLayout(null);
        this.add(conPan);


        conPan.add(Functions.createCustomLabelWithBorder(
            "Nom Complet",
            130, 15, 200, 25,
            5, 5, 5, 5,
            col
        ...
        for(int i = 0 ; i < students.size() ; i++){
            ...
            JLabel fullName = Functions.createCustomLabelWithBorder(
            ...
            JLabel cne = Functions.createCustomLabelWithBorder(
                    students.get(i)[2],
                    360, 45 + 30 * i, 150, 25,
                    5, 5, 5, 5,
                    new Color(204 , 255 , 255)
            ...
            mark.setBackground(new Color(0, 0, 0, 0)); 
            mark.setBorder(null);

            // 🔒 allow only numbers and '.' and keep value between 0 and 20
...
//==================================================//
// Filter: accept only digits + one '.' and keep 0 <= value <= 20
